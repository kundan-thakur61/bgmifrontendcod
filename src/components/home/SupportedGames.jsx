        ...
        <section className="py-16 sm:py-24 px-3 sm:px-4 relative">
            ...
            <div className="relative max-w-7xl mx-auto">
                <div className="text-center mb-10 sm:mb-16">
                    ...
                    <p className="text-base sm:text-xl text-gray-400 max-w-2xl mx-auto font-light px-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8">
                    {games.map((game, index) => (
                        <div
                            key={game.name}
                            className="game-card p-6 sm:p-8 rounded-2xl text-center bg-gray-900/50"
                            style={{
                                animation: `fadeInUp 0.6s ease-out ${index * 0.15}s backwards`
                            }}
                        >
                            <div className="text-5xl sm:text-7xl mb-4 sm:mb-6 transform hover:scale-110 transition-transform duration-300 will-change-transform translate-z-0">
                                {game.icon}
                            </div>
                            <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 text-white hero-title">
                                {game.name}
                            </h3>
