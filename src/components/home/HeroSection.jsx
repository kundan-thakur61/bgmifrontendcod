    ...
    return (
        <section className="relative pt-20 pb-12 sm:pt-32 sm:pb-24 px-3 sm:px-4 overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto text-center">
                <div className="inline-flex items-center px-4 py-2 sm:px-6 sm:py-3 bg-black/60 backdrop-blur-xl rounded-full border border-accent-500/30 mb-6 sm:mb-10 holographic">
                    <span className="w-2 h-2 sm:w-3 sm:h-3 bg-accent-400 rounded-full mr-2 sm:mr-3 live-indicator hero-live-dot" aria-hidden="true" />
                    <span className="text-xs sm:text-sm font-semibold text-accent-400 tracking-wider uppercase">Live Matches Available Now</span>
                </div>
                ...
                <p className="text-base sm:text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-8 sm:mb-12 font-light leading-relaxed px-2 hero-fade">
                    Join daily <span className="text-accent-400 font-semibold">BGMI tournaments</span> and custom rooms on BattleXZone. <span className="text-purple-400">Compete with top players in India, showcase your skills, and win real cash prizes today!</span>
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mb-12 sm:mb-20 px-2 hero-fade hero-fade-delay">
                    <Link
                        href="/register"
                        className="cta-button w-full sm:w-auto px-8 sm:px-10 py-4 sm:py-5 bg-gradient-to-r from-accent-500 to-accent-600 text-black rounded-lg text-base sm:text-lg font-bold shadow-lg hover:shadow-accent-500/50 transition-all duration-300 hover:scale-105 text-center min-h-[48px]"
                        data-track="register"
                    >
                        Register & Play Now
                    </Link>
                    <Link
                        href="/how-it-works"
                        className="cta-button w-full sm:w-auto px-8 sm:px-10 py-4 sm:py-5 bg-transparent border-2 border-accent-400 text-accent-400 rounded-lg text-base sm:text-lg font-bold hover:bg-accent-400/10 transition-all duration-300 hover:scale-105 text-center min-h-[48px]"
                    >
                        How It Works
                    </Link>
                </div>
