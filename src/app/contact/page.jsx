            ...
            <main className="min-h-screen bg-dark-900 pt-16 sm:pt-20 pb-12">
                <div className="container mx-auto px-3 sm:px-4 max-w-4xl">
                    <div className="text-center mb-12">
                        <h1 className="text-3xl sm:text-4xl font-bold mb-4 font-display gradient-text">Contact Us</h1>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {/* Support Tickets */}
                        <div className="card p-6 sm:p-8 hover:border-primary-500/50 transition-colors">
                        ...
                        {/* Email Support */}
                        <div className="card p-6 sm:p-8 hover:border-gaming-purple/50 transition-colors">
                        ...
                        {/* Social Media */}
                        <div className="card p-6 sm:p-8 col-span-1 md:col-span-2 hover:border-blue-500/50 transition-colors">
